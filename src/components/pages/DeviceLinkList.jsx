...
const DeviceLinkList = () => {
    ...
    const initialValues = {
      ...
      const {
        ...
        validationSchema: DeviceLinkValidation,
    ...
    return (
        ...
        <ToastContainer />
            ...
            <Popup showupdate={showupdate} id= {id} handleUpdate={handleUpdate} setShowupdate={setShowupdate} resetForm={resetForm} handleSubmit={handleSubmit}  openPopup={openPopup} setOpenPopup={setOpenPopup} title="Device Link">

                <DeviceLinkForm values={values} touched={touched} errors={errors} handleBlur={handleBlur} handleChange={handleChange} setFieldValue={setFieldValue} handleSubmit={handleSubmit} />
