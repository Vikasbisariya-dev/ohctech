...
const JobProfileList = () => {
    ...
    const initialValues = {
      ...
      const {
        ...
        validationSchema: JobProfileValidationForm,
   ...
   const CustomActionComponent = ({id}) => {
    ...
    return (
        ...
        <ToastContainer />
            ...
            <Popup showupdate={showupdate} id= {id} handleUpdate={handleUpdate} setShowupdate={setShowupdate} resetForm={resetForm} handleSubmit={handleSubmit}  openPopup={openPopup} setOpenPopup={setOpenPopup} title="Job Profile ">

                <JobProfileForm values={values} touched={touched} errors={errors} handleBlur={handleBlur} handleChange={handleChange} setFieldValue={setFieldValue} handleSubmit={handleSubmit} />
