...
import { CategoryValidationForm } from './Validationform';
   ...
   const CustomActionComponent = ({id}) => {
    ...
    const exportExcelfile = async () => {
      ...
      sheet.getRow(1).font = { bold: true };
        ...
        workbook.xlsx.writeBuffer().then(data => {
            ...
            anchor.href = url;
            anchor.download = 'CategoryList.xlsx';
            anchor.click();
    ...
    return (
        ...
        <ToastContainer />
            ...
            <Popup showupdate={showupdate} id= {id} handleUpdate={handleUpdate} setShowupdate={setShowupdate} resetForm={resetForm} handleSubmit={handleSubmit}  openPopup={openPopup} setOpenPopup={setOpenPopup} title="Category">

                <CategoryForm values={values} touched={touched} errors={errors} handleBlur={handleBlur} handleChange={handleChange} setFieldValue={setFieldValue} handleSubmit={handleSubmit} />
