...
const HealthReportableParameterList = () => {
    ...
    const initialValues = {
      ...
      const {
        ...
        validationSchema: HealthReportableParameterValidationForm,
       ...
       const CustomActionComponent = ({id}) => {
        ...
        const exportpdf = async () => {
            ...
            doc.save("HealthReportableParameterList.pdf");
        };
    ...
    return (
        ...
        <ToastContainer />
            ...
            <Popup showupdate={showupdate} id= {id} handleUpdate={handleUpdate} setShowupdate={setShowupdate} resetForm={resetForm} handleSubmit={handleSubmit}  openPopup={openPopup} setOpenPopup={setOpenPopup} title="Key Health Reportable Parameter Master ">

                <HealthReportableParameterForm values={values} touched={touched} errors={errors} handleBlur={handleBlur} handleChange={handleChange} setFieldValue={setFieldValue} handleSubmit={handleSubmit} />
...
export default HealthReportableParameterList;
