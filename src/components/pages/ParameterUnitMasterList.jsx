...
const ParameterUnitMasterList = () => {
    ...
    const initialValues = {
      ...
      const {
        ...
        validationSchema: ParameterUnitMasterValidationForm,
       ...
       const CustomActionComponent = ({id}) => {
        ...
        const exportpdf = async () => {
            ...
            doc.save("ParameterUnitMasterList.pdf");
        };
    ...
    return (
        ...
        <ToastContainer />
            ...
            <Popup showupdate={showupdate} id= {id} handleUpdate={handleUpdate} setShowupdate={setShowupdate} resetForm={resetForm} handleSubmit={handleSubmit}  openPopup={openPopup} setOpenPopup={setOpenPopup} title="Parameter Unit Master ">

                <ParameterUnitMasterForm values={values} touched={touched} errors={errors} handleBlur={handleBlur} handleChange={handleChange} setFieldValue={setFieldValue} handleSubmit={handleSubmit} />
...
export default ParameterUnitMasterList;
