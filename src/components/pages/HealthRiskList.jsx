...
const HealthRiskList = () => {
   ...
   const CustomActionComponent = ({id}) => {
    ...
    const exportpdf = async () => {
        const doc = new jsPDF();
        const header = [['Id', 'Health Risk Name',"Health Advice Category"]];
    ...
    const exportExcelfile = async () => {
      ...
      sheet.getRow(1).font = { bold: true };
        ...
        sheet.columns = [
          ...
          { header: "Health Risk Name", key: 'HealthRiskName', width: columnWidths.HealthRiskName, style: headerStyle },
        ...
        rowData.map(product =>{
            sheet.addRow({
                id: product.id,
                HealthRiskName: product.HealthRiskName,
    ...
    return (
        ...
        <ToastContainer />
            ...
            <Popup showupdate={showupdate} id= {id} handleUpdate={handleUpdate} setShowupdate={setShowupdate} resetForm={resetForm} handleSubmit={handleSubmit}  openPopup={openPopup} setOpenPopup={setOpenPopup} title="Health Risk ">

                <HealthRiskForm values={values} touched={touched} errors={errors} handleBlur={handleBlur} handleChange={handleChange} setFieldValue={setFieldValue} handleSubmit={handleSubmit} />
