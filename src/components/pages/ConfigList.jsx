...
//import { ConfigValidationForm } from './Validationform';
...
const ConfigList = () => {
    ...
    const initialValues = {
      ...
      const {
        ...
        validationSchema: ConfigValidationForm,
   ...
   const CustomActionComponent = ({id}) => {
    ...
    const exportpdf = async () => {
        ...
        const doc = new jsPDF();
        const header = [['Id', 'Key name',"Valued"]];
    ...
    const exportExcelfile = async () => {
      ...
      sheet.getRow(1).font = { bold: true };
        ...
        sheet.columns = [
          ...
          { header: "Valued", key: 'valued', width: columnWidths.valued, style: headerStyle },
    ...
    return (
        ...
        <ToastContainer />
            ...
            <Popup showupdate={showupdate} id= {id} handleUpdate={handleUpdate} setShowupdate={setShowupdate} resetForm={resetForm} handleSubmit={handleSubmit}  openPopup={openPopup} setOpenPopup={setOpenPopup} title="Config">
                ...
                <ConfigForm values={values} touched={touched} errors={errors} handleBlur={handleBlur} handleChange={handleChange} setFieldValue={setFieldValue} handleSubmit={handleSubmit} />
